...
N_SPLITS = 5
SUBMISSION_PATH = DATA_DIR / "submission_logreg_5fold.csv"
OOF_PATH = DATA_DIR / "oof_logreg_5fold.csv"
...
def main() -> None:
    ...
    for fold, (train_idx, valid_idx) in enumerate(folds.split(x, y), start=1):
        print(f"\nTraining logistic fold {fold}/{N_SPLITS}...", flush=True)
